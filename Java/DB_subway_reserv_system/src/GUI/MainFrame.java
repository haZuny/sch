...
public class MainFrame extends JFrame {
	...
	public void change(String panelName, HashMap<String, String> user, String year) {
		// 예약 화면으로 전환
		if (panelName.equals("reservePage")) {
			getContentPane().removeAll();
//			getContentPane().add(new ReservePage(this, user, year));
			revalidate();
			repaint();
		}
	}
